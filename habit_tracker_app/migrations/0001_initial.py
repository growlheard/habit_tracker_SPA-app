    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associated_habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='habit_tracker_app.habit', verbose_name='связанная привычка')),
            ],
            options={
